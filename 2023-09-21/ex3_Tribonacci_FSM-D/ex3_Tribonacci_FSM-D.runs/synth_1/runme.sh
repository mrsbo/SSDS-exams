...
HD_PWD='/home/sbo/SSDS/Exams/2023-09-21/ex3_Tribonacci_FSM-D/ex3_Tribonacci_FSM-D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tribonacci_HLSM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tribonacci_HLSM.tcl
