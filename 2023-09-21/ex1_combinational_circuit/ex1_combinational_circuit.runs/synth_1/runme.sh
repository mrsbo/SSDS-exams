...
HD_PWD='/home/sbo/SSDS/Exams/2023-09-21/ex1_combinational_circuit/ex1_combinational_circuit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log therm2bin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source therm2bin.tcl
